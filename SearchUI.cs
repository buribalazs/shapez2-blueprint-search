...
public static class SearchUI
{
    ...
    {
        // Container — 55 % of panel width, positioned below the game's "Blueprint Library" header
        ...
        clearRT.sizeDelta       = new Vector2(36f, 36f);
        ...
        // Text area — right margin widened to make room for the larger clear button
        var textAreaGO = new GameObject("Text Area");
        textAreaGO.transform.SetParent(go.transform, false);
        var textAreaRT = textAreaGO.AddComponent<RectTransform>();
        textAreaRT.anchorMin       = Vector2.zero;
        textAreaRT.anchorMax       = Vector2.one;
        textAreaRT.sizeDelta       = new Vector2(-54f, -6f);
        textAreaRT.anchoredPosition = new Vector2(-19f, 0f);
